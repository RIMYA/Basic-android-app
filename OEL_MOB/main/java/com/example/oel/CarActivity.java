...
public class CarActivity extends AppCompatActivity {
    ...
    public void onRadioButtonClicked(View view) {
        ...
        switch (view.getId()) {
            case R.id.radio_On:
                if (checked) {
                    Toast.makeText(CarActivity.this, "The AC is ON", Toast.LENGTH_SHORT).show();
                }
                break;
            case R.id.radio_Off:
                if (checked) {
                    Toast.makeText(CarActivity.this, "The AC door is OFF", Toast.LENGTH_SHORT).show();
                }
                break;
    ...
    public void onRadioButton2Clicked(View view) {
        ...
        switch (view.getId()) {
            case R.id.radio2_On:
                if (checked) {
                    Toast.makeText(CarActivity.this, "The ignition is ON", Toast.LENGTH_SHORT).show();
                }
                break;
            case R.id.radio2_Off:
                if (checked) {
                    Toast.makeText(CarActivity.this, "The ignition door is OFF", Toast.LENGTH_SHORT).show();
                }
                break;
